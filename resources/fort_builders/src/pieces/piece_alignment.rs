...
// piece type index
fn get_enm_type() -> Vec<u8> {
    vec![3, 3, 3, 3, 4, 3, 3, 4]
}

fn get_def_type() -> Vec<u8> {
    vec![
        4, 1, 2, 0, 3, 3, 3, 3, 4, 2, 1, 4, 3, 3, 3, 3, 0, 1, 2, 4, 3, 3, 3, 3,
    ]
}
